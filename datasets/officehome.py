    ...
    def _read_data(self, input_domains):
        ...
        for domain, dname in enumerate(input_domains):
            ...
            class_names = ["Drill", "Exit_Sign", "Bottle", "Glasses", "Computer", "File_Cabinet", "Shelf", "Toys", 
                           ...
                           "Helmet", "Mouse", "Pen", "Monitor", "Mop", "Sneakers", "Notebook", "Backpack", "Alarm_Clock", 
                           "Push_Pin", "Paper_Clip", "Batteries", "Radio", "Fan", "Ruler", "Pan", "Screwdriver", 
                           "Trash_Can", "Printer", "Speaker", "Eraser", "Bucket", "Chair", "Calendar", "Calculator", 
                           "Flowers", "Lamp_Shade", "Spoon", "Candles", "Clipboards", "Scissors", "TV", "Curtains", 
                           "Fork", "Soda", "Table", "Knives", "Oven", "Refrigerator", "Marker"]
